...
from backend.models.schemas import AnalysisResponse, AnalysisHistoryItem
...
async def analyze_resume(
    ...
    - Scanned/image PDFs: rendered as images and read via Gemini Vision OCR

    Flow:
    1. Validate PDF upload
    2. Extract text (with Vision OCR fallback for scanned PDFs)
    ...
    # Step 2 — Extract text (auto-detects scanned vs text-based)
